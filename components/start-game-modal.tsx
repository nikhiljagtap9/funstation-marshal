...
import NewYearAnimation from "./new-year-animation";
				...
				<div className="space-y-6">
					<Alert className="bg-blue-100 border-blue-200">
						...
						<AlertDescription className="text-blue-700">
							Please read all rules carefully before starting the
							competition.
						</AlertDescription>
					</Alert>
					...
					<div className="bg-gradient-to-r from-red-600/5 to-orange-600/5 rounded-lg p-4 border border-red-400/10">
						...
						<p className="text-sm text-gray-600">
							All game times are manually input by the marshal.
							Make sure to track each team's performance
							accurately. The system will automatically calculate
							bonuses and penalties based on the game rules.
						</p>
					</div>
