...
export default function GameTimer({
	...
	// Remove all House of Cards special logic (creativityBonus, winnerStatus, bonusSeconds, etc.)
	// Use only minutes/seconds input and completion logic for all games
