...
export default function SplashPage() {
	...
	useEffect(() => {
		...
		try {
			...
			ws.onopen = () => {
				console.log("Splash WebSocket connected successfully");
				setWsConnected(true);
			};
			...
			ws.onmessage = (event) => {
				try {
					...
					console.log("Splash WebSocket message received:", msg);
			...
			ws.onclose = () => {
				console.log("Splash WebSocket disconnected");
				setWsConnected(false);
			};

			ws.onerror = (error) => {
				console.warn("Splash WebSocket connection failed:", error);
				setWsConnected(false);
			};
			...
			console.warn("Splash WebSocket setup failed:", error);
			setWsConnected(false);
